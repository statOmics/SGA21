...
pkgs <- c("SingleCellExperiment", "DropletUtils", "scRNAseq", "scater", "scuttle", "scran", "BiocSingular", "scDblFinder")
...
## A (non-linear) generalization of PCA for exponential family distributions.

```{r, eval=FALSE}
library(glmpca)
set.seed(211103)
poipca <- glmpca(assays(sce)$counts,
                 L=2, fam="poi",
                 minibatch="stochastic")
reducedDim(sce, "PoiPCA") <- poipca$x
plot
```
