...
1. Introduction to sequencing technology, raw data and preprocessing.
   ...
   - Lecture: [Introduction to sequencing](./sequencing_intro.html) [(PDF version)](./sequencing_intro.pdf).
   - Tutorial: 
...
2. Working with count data and generalized linear models.
   ...
   - Lecture: [Working with count data and GLMs](./sequencing_countData.html) [(PDF version)](./sequencing_countData.pdf).
   - Tutorial: Embedded within the lecture: Analysis of bike-sharing data.

\newline

3. Analysis of RNA-seq data.

   - Lecture + Tutorial: [Four major challenges in the analysis of RNA-seq datasets](./sequencing_rnaseqIntro.html) [(PDF version)](./sequencing_rnaseqIntro.pdf).
